...
// ***Parameters***
   // desired inclination for final orbit in degrees
PARAMETER desiredInclination.
   // desired altitude of final orbit in km
PARAMETER desiredApoapsis.	
	// vertical speed to start pitch maneuver in meters per second
PARAMETER desiredVerticalSpeedForPitch.
