...
LOCAL deployAlt to 80000.
	// If there is an extra stage step needed before launch
LOCAL extraLaunchStage to FALSE.
//*************************
...
FUNCTION checkNominalThrust {
	...
	pOut(SHIP:AVAILABLETHRUSTAT(1.0)).
...
FUNCTION calculateLaunchDetails {
	...
	LOCAL launch_details IS calcLaunchDetails(desiredApoapsis,desiredInclination,desiredLAN).
